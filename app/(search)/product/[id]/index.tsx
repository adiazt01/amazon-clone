	...
	return (
		<>
			<ScrollView f={1} gap={20} bg={"white"} p={20}>
				...
				<Text>
					The prices of products sold on Amazon include VAT. Depending
					on your delivery address, VAT may vary at the checkout. For
					more information click somewhere.
				</Text>
				<XStack my={20}>
					<Text>
